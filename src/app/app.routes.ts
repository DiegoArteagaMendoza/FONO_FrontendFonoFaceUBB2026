...
import { PmSeguimientoComponent } from '../proyectos/portalMedico/features/terapia/seguimiento/seguimiento';
import { PmSeguimientoDetalleComponent } from '../proyectos/portalMedico/features/terapia/seguimiento/detalle/detalle';
...
export const routes: Routes = [
  ...
  // propia sesión JWT (ver PortalMedicoService) y su propio layout con navbar.
  {
    ...
    children: [
      ...
      // Seguimiento de terapia: pacientes con plan (semáforo) y detalle con retroalimentación
      { path: 'seguimiento', component: PmSeguimientoComponent },
      { path: 'seguimiento/:id', component: PmSeguimientoDetalleComponent },
