...
import { VozService } from '@core/services/voz/voz';
import { TextosService } from '@core/services/textos/textos';

@Component({
  selector: 'app-crear-voz',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './crear.html',
  // styleUrls: ['./crear.scss'] // O comentado si usas el global
})
export class CrearVoz {
  ...
  onSubmit(): void {
    ...
    this.vozService.crearVoz(formData).subscribe({
      next: (respuesta) => {
        console.log('Contenido de voz creado con éxito', respuesta);
